...
const swlSuccess = (text: any) => {
  Swal.fire(
    'Repuesto '+ text,
    'El repuesto ha sido '+ text +' exitosamente',
    'success'
  )
}
const swlErr = () => {
...
const formSchema = Yup.object().shape({
  ...
  nombre: Yup.string().required('Nombre Usuario es requerido'),
...
const formSchema2 = Yup.object().shape({
  ...
  nombre2: Yup.string().required('Nombre Usuario es requerido'),
...
const Repuestos: FC = () => {
  ...
  const baseUrl = 'https://crisalex.cl/api/?metodo=repuestos'
    ...
    <div className={`card mb-5 mb-xl-8`}>
      ...
      <MaterialTable
          ...
          options={{
            ...
            exportMenu: [{
              label: 'Exportar PDF',
              exportFunc: (cols, x) => ExportPdf(cols, data, 'Repuestos')
            },{
              label: 'Exportar CSV',
              exportFunc: (cols, x) => ExportCsv(cols, data, 'Repuestos')
            }]
          }}
          localization={{
            header:{
      ...
      <Modal isOpen={modalInsertar} scrollable>
        ...
        <div className='modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15'>
          <div className='text-center mb-13'>
            ...
            <div className='text-muted fw-bold fs-5'>Ingresar los campos de repuestos</div>
          </div>
      ...
      <Modal isOpen={modalEliminar} className="p-5 my-10">
        <ModalBody className='d-flex justify-content-center'>
          ...
          ¿Estás seguro que deseas eliminar el repuesto
                <br />
